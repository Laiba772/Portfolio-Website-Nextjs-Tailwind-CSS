...
const About = () => {
  ...
  return (
    <main className="mt-16 md:mt-20 lg:my-28">
      <div
        id="about-section"
        className={`flex flex-col md:flex-row w-[95%] lg:w-[90%] justify-between items-center text-white mx-auto transition-all duration-700 ease-in-out ${
      ...
      >
        ...
        <div className="w-[95%] md:w-[60%] lg:w-[50%] mx-auto">
          ...
          <h2 className="font-bold text-2xl lg:text-4xl mt-10 mb-6 md:mt-1 md:mb-4 font-serif text-lavender">
